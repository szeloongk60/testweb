...
export interface ERC20MintableBurnableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'allowance'
      | 'approve'
...
export interface ERC20MintableBurnable extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20MintableBurnable
  ...
  burnFrom: TypedContractMethod<
    [payer_: AddressLike, amount_: BigNumberish],
    [void],
    'nonpayable'
  >
  ...
  mintTo: TypedContractMethod<
    [receiver_: AddressLike, amount_: BigNumberish],
    [void],
    'nonpayable'
  >
