...
export interface ERC1155MintableBurnableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'balanceOf'
      | 'balanceOfBatch'
...
export interface ERC1155MintableBurnable extends BaseContract {
  connect(runner?: ContractRunner | null): ERC1155MintableBurnable
  ...
  burnFrom: TypedContractMethod<
    [payer_: AddressLike, tokenId_: BigNumberish, amount_: BigNumberish],
    [void],
    'nonpayable'
  >
